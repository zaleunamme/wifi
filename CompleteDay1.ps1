...
!!!DAPAT 7 UNDER21SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
!!!DAPAT  UNDER SCORE ANG NA EDIT MO  ( LINE 72 to 99 PASTE TO COREBABA SWITCH )
!@@@LEAF SWITCH
config t
...
conf t
 ...
 ip route 10..0.0 255.255.0.0 200.0.0.
...
http://docwiki.cisco.com/wiki/Cisco21IOS21Voice21Troubleshooting21and21Monitoring21--21Tcl21IVR21Troubleshooting
